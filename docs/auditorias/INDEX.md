...
| `20260627-AUD-IMG-OVR-03 khwan-resvg-regression` | 2026-06-27 | Tofu + flecha superpuesta en producción, #2 Khwăn→#1 Khien — cerrada: título pre-renderizado como PNG (`@napi-rs/canvas`/Skia); follow-up §12 rutas Vercel (solo flechas staging) | closed | [20260627-AUD-IMG-OVR-03-khwan-resvg-regression.md](./20260627-AUD-IMG-OVR-03-khwan-resvg-regression.md) |
