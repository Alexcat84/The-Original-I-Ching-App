...
Durante la revisión del fix de `LIBRARY_HEXAGRAM_TITLE_FIDELITY_FIX_2026-06-23.md`
...
- `scripts/build-hexagrams.mjs` — comentario de cabecera corregido: ya no dice
  ...
  (quedó desactualizado tras `LIBRARY_HEXAGRAM_TITLE_FIDELITY_FIX_2026-06-23.md`);
