...
Descubiertos tras instalar APK 3.5.6/vc54 en dispositivo. Documentados en `20260613-AUD-MOB-HYD-03-hydration-gate.md`.
...
- [x] **TDZ P0:** `imagePrompt` TDZ en `stream_ritual` + Sentry.captureException — rama `fix/tdz-image-prompt-sentry`
  - Documentado en `docs/auditorias/20260613-PLAN-ANM-01-animation-plan-v3.md` (§1)
  - Brief de Acción 3 en `docs/auditorias/00000000-BRIEF-ANM-02-submit-reveal-redesign.md`
- [x] **Animation plan v3 Acciones 2–7** — rama `feat/animation-plan-v3` (`60dbee4`), mergeada a staging+main (`9209da5`)
  ...
  - **Verificado** por auditoría independiente — ver `20260613-PLAN-ANM-01-animation-plan-v3.md` §10
