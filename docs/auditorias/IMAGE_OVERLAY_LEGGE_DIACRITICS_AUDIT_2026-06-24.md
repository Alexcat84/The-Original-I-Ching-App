...
- **Fecha:** 2026-06-24
- **Estado:** ✅ **Fix diacríticos aplicado** — gate `verify:overlay-glyphs` verde; **layout mutación / flecha → cerrado** → ver [`IMAGE_OVERLAY_MUTATION_TITLE_LAYOUT_AUDIT_2026-06-25.md`](./IMAGE_OVERLAY_MUTATION_TITLE_LAYOUT_AUDIT_2026-06-25.md) §10
