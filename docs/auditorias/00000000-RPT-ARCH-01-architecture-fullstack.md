...
|-------|--------|------------|
| 2026-06-21 | Selector lectura líneas Huang/Zhu Xi (`line_reading_system`, migración 074); SSE `final_ready` + JSON manual exponen `lineReadingSystem` | `20260620-AUD-LRS-01-zhuxi-line-reading-selector.md` |
