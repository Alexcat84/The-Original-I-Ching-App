...
Ver [`docs/runbooks/00000000-RUN-SUP-01-migration-data-integrity.md`](../runbooks/00000000-RUN-SUP-01-migration-data-integrity.md).
...
| Recurso | Ubicación |
|---------|-----------|
| Runbook operativo | `docs/runbooks/00000000-RUN-SUP-01-migration-data-integrity.md` |
...
| Auditoría estabilidad | `docs/auditorias/00000000-AUD-SUP-01-supabase-db-stability.md` §14 |
