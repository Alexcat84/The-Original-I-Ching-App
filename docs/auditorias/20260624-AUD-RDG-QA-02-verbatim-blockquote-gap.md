...
- **Relacionado (contexto distinto):** [20260623-AUD-RDG-QA-01-judgment-regression.md](./20260623-AUD-RDG-QA-01-judgment-regression.md) cubrió **corrupción del bundle** (dato roto en sync). Este documento cubre **salida del modelo** cuando el bundle **ya es correcto**.
...
- Revisar volumen/patrón de `judgment_image_verbatim_drift` en Sentry tras acumular tráfico real
  ...
  descartado; ver [20260622-AUD-MUT-05-retry-fallback-economics.md](./20260622-AUD-MUT-05-retry-fallback-economics.md) para H2, fallback chain y entrega al usuario.
