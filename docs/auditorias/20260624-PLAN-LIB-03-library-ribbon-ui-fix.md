...
- **Relacionado:** [`20260623-PLAN-LIB-01-library-commentary-layer.md`](./20260623-PLAN-LIB-01-library-commentary-layer.md) (feature original), [`CommentaryRibbon.tsx`](../../apps/web/src/components/library/CommentaryRibbon.tsx), [`HexagramTabs.tsx`](../../apps/web/src/components/library/HexagramTabs.tsx), [`globals.css`](../../apps/web/src/app/globals.css)
...
2. ✅ Nota de cierre en [`20260623-PLAN-LIB-01-library-commentary-layer.md`](./20260623-PLAN-LIB-01-library-commentary-layer.md) §10.
...
- Mismo commit corrige, en `backend/claude`, una etiqueta de traductor incorrecta en el Gate H7 (no relacionado a este bug de UI, ver `20260624-AUD-RDG-QA-02-verbatim-blockquote-gap.md` §11).
