...
- **Relacionado:**
  - [PROMPT_MUTATION_RULES_AUDIT_2026-06-15.md](./PROMPT_MUTATION_RULES_AUDIT_2026-06-15.md) — Fase 2, Opción B (fallback chain + H2 retry)
  - [READING_QUALITY_QA_VERBATIM_BLOCKQUOTE_GAP_AUDIT_2026-06-24.md](./READING_QUALITY_QA_VERBATIM_BLOCKQUOTE_GAP_AUDIT_2026-06-24.md) — H7 warn-only, reintento H7 diferido
  - [GENERAL_PRE_PRODUCCION_2026-06-16.md](./GENERAL_PRE_PRODUCCION_2026-06-16.md) — §3 integridad financiera, §4 cadena fallback
...
| Opción B original | `docs/auditorias/PROMPT_MUTATION_RULES_AUDIT_2026-06-15.md` §PR2 |
