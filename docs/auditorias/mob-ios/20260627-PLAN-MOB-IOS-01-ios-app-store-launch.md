...
**Colección:** [`docs/auditorias/mob-ios/`](./INDEX.md) · **Implementación Fase 2:** [`20260627-PLAN-MOB-IOS-02-fase2-implementation-plan-v1.md`](./20260627-PLAN-MOB-IOS-02-fase2-implementation-plan-v1.md) (v1.0, pending review)
...
**Plan de implementación detallado (v1.0):** [`20260627-PLAN-MOB-IOS-02-fase2-implementation-plan-v1.md`](./20260627-PLAN-MOB-IOS-02-fase2-implementation-plan-v1.md)
...
- **Colección MOB-IOS:** [`INDEX.md`](./INDEX.md)
- **Implementación Fase 2 v1.0:** [`20260627-PLAN-MOB-IOS-02-fase2-implementation-plan-v1.md`](./20260627-PLAN-MOB-IOS-02-fase2-implementation-plan-v1.md)
...
- `20260619-FIX-MOB-PLAY-01-play-data-safety.md` — referencia privacy Play
...
| 2026-06-27 | Revisado un segundo input externo (Grok). Se descarta explícitamente su recomendación central (template WKWebView separado / migrar a Capacitor). Se incorpora D6 (push notifications) y redacción base para las notas del reviewer. |
| 2026-06-27 | Creada la rama `feature/ios-app-store-launch` (base: `staging`). Flujo Cursor → revisión Claude → implementación → auditoría antes de merge. |
| 2026-06-27 | Plan movido a colección dedicada `docs/auditorias/mob-ios/`. Publicado PLAN-MOB-IOS-02 v1.0 (implementación Fase 2 detallada, pending review). |
