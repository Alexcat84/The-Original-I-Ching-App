...
**Regla:** sin merge a `staging`/`main` hasta (1) Cursor incorpore los 2 fixes de typecheck de la auditoría post-implementación Claude (`apps/mobile/tsconfig.json` `moduleSuffixes`; fallback `?? ''` en la llamada a `signInWithAppleSupabase`) y (2) validación Alex (EAS preview + Sign in with Apple E2E tras deploy web staging).
...
| `20260627-PLAN-MOB-IOS-02 fase2-implementation-plan-v1` | **v1.2** | Plan de implementación Fase 2 (§4.1–4.7) | **implementado — 2 fixes typecheck requeridos antes de merge (auditoría Claude 2026-06-27)** | [20260627-PLAN-MOB-IOS-02-fase2-implementation-plan-v1.md](./20260627-PLAN-MOB-IOS-02-fase2-implementation-plan-v1.md) |
