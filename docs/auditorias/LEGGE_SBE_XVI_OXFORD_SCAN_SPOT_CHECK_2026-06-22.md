...
4. **Cerrar métrica:** re-ejecutar `npm run verify:hexagram-fidelity:pdf-legge` y actualizar [ICHING_TRANSLATOR_DATA_FIDELITY_AUDIT_2026-06-21.md](./ICHING_TRANSLATOR_DATA_FIDELITY_AUDIT_2026-06-21.md).
