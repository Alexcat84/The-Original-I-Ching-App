...
**Relacionado:** [SUPABASE_DB_STABILITY_AUDIT.md](../auditorias/SUPABASE_DB_STABILITY_AUDIT.md), [SUPABASE_POST_RESTART.md](./SUPABASE_POST_RESTART.md), [MIGRATION_DATA_INTEGRITY.md](./MIGRATION_DATA_INTEGRITY.md)
...
| Nunca 066 sin 068 | `docs/runbooks/MIGRATION_DATA_INTEGRITY.md` |
