...
**Código:** `00000000-WF-I18N-01 i18n-guide` · **Familia:** I18N · **Estado:** reference
...
**Historial del cambio de arquitectura:** [`00000000-WF-I18N-02-i18n-standardization.md`](./00000000-WF-I18N-02-i18n-standardization.md)

**¿Vas a cambiar el contenido de una FAQ/guía/nota existente, no a agregar un idioma?** Usa
[`00000000-WF-DOC-01-docs-content-update-guide.md`](./00000000-WF-DOC-01-docs-content-update-guide.md) — cubre fuentes citables, nivel de
...
docs/workflows/00000000-WF-I18N-02-i18n-standardization.md    (historial arquitectura)
```
