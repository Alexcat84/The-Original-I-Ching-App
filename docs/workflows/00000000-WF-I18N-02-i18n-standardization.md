...
- [`00000000-WF-I18N-01-i18n-guide.md`](./00000000-WF-I18N-01-i18n-guide.md) — checklist operativo para añadir un idioma (actualizado al proceso post-estandarización)
...
| 6 | `9f5fc8b` | **Stage 5** — primera actualización `00000000-WF-I18N-01-i18n-guide.md`; eliminar `chat-suggestions.ts` |
...
- Primera pasada de actualización de `00000000-WF-I18N-01-i18n-guide.md`
...
| `30ab092` | `credits-ui-copy.ts`: default `DEFAULT_LOCALE`; creación de `00000000-WF-I18N-02-i18n-standardization.md` |
...
- [ ] `CHANGELOG.md`
- [ ] Commit final de docs si hay cambios locales pendientes en `00000000-WF-I18N-01-i18n-guide.md` / este archivo
...
- [00000000-WF-I18N-01-i18n-guide.md](./00000000-WF-I18N-01-i18n-guide.md) — añadir idioma nuevo (proceso vigente)
- [CLAUDE.md](../../CLAUDE.md)
