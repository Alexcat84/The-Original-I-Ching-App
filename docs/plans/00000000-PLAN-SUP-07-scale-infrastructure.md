...
**Código:** `00000000-PLAN-SUP-07 scale-infrastructure` · **Familia:** SUP · **Estado:** reference
...
> Diagnóstico: auditoría completa en [`docs/auditorias/00000000-AUD-SUP-02-warp-timeout-kills.md`](../auditorias/00000000-AUD-SUP-02-warp-timeout-kills.md)  
...
- **0C Medium:** Infra real reportada = **Small** (~$10 add-on sobre Pro). Medium (~$50) sigue siendo opcional post-lanzamiento; alinear con `docs/runbooks/00000000-RUN-SUP-02-supabase-scalability.md` §8 (ticket pide pool, no Medium).
...
- **Smoke “0 Warp en 10 min”:** no cerrado formalmente. `docs/runbooks/00000000-RUN-SUP-03-smoke-post-small.md` sigue FAIL (kick OAuth pre-`eeea551`). Logs prod 2026-06-11 23:00–23:46 UTC = ventana sana (51 entradas, 0 Warp) — evidencia positiva pero no sustituye smoke en dispositivo post-Fase 7.
...
7. Cerrar smoke post-Fase 7 en dispositivo + actualizar `00000000-RUN-SUP-03-smoke-post-small.md`.
