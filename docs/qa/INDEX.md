...
| `VF-FID-W-037 sync-wilhelm-de-comments-meta-from-erstes` | `scripts/sync-wilhelm-de-comments-meta-from-erstes.mjs` | 1.0.0 | `sync:wilhelm-de-comments-meta-from-erstes` | 20260628-PLAN-DAT-W-05 | chinese_roman from Erstes |
| `VF-FID-W-038 verify-wilhelm-de-en-structure-parity` | `scripts/verify-wilhelm-de-en-structure-parity.mjs` | 1.0.0 | `verify:wilhelm-de-en-structure-parity` | 20260628-PLAN-DAT-W-05 | EN↔DE fill parity gate |
