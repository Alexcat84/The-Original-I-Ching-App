...
(function () {
  ...
  _st.textContent = [
    ...
    /* Chat drawer: ensure list content isn't hidden under Android bottom nav bar */
    'html.iching-rn-webview .chat-drawer-list{padding-bottom:max(0.5rem,env(safe-area-inset-bottom,0px))!important}',
