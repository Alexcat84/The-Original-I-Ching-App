...
(function () {
  ...
  _st.textContent = [
    ...
    '@media (max-width:520px){.composer-minibar{padding-top:0.28rem!important;padding-left:0.55rem!important;padding-right:0.55rem!important;padding-bottom:calc(0.1rem + min(22px,env(safe-area-inset-bottom,0px)))!important;gap:0.35rem!important;align-items:center!important}.composer-minibar .composer-input-row{gap:0.35rem!important;margin-top:0!important}.composer-minibar .composer-input-row textarea{min-height:2.08rem!important;padding:0.42rem 0.72rem!important;font-size:0.92rem!important}.composer-minibar .composer-input-row>button{width:2.42rem!important;height:2.42rem!important;font-size:1rem!important}.composer-options-btn{min-width:2.7rem!important;padding:0.24rem 0.26rem!important;border-radius:18px!important}}',
    'html.iching-rn-webview footer.chat-composer-wa{padding-bottom:0!important}',
    'html.iching-rn-webview .composer-minibar{padding-bottom:calc(2px + min(18px,env(safe-area-inset-bottom,0px)))!important}'
  ].join(';');
