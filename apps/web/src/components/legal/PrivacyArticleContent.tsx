import type { DocNavUiMessages, PrivacyPageMessages } from "@iching-oracle/i18n";
import Link from "next/link";

type PrivacyArticleContentProps = {
  messages: PrivacyPageMessages;
  nav: DocNavUiMessages;
};

export function PrivacyArticleContent({ messages: p, nav }: PrivacyArticleContentProps) {
  return (
    <>
      <h1>{p.title}</h1>
