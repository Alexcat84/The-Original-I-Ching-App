              ...
              >
                <div className="composer-sheet-inner">
                  <section className="oracle-card composer-card">
                    ...
                    {inRnWebView ? (
                      /* APK only: inside the WebView the marketing site is not
                         reachable, so docs/feedback keep living here. In the
                         browser these moved to the marketing site at "/". */
                      <div
      ...
      <JoyrideNoSSR
        ...
        steps={
          [
            ...
            // Doc links only exist inside the APK WebView (browser users get them on the marketing site).
            ...(inRnWebView
              ? [{ target: "#tour-doc-links", title: tour.step8Title, content: tour.step8Body, placement: "top" as const, before: tourBeforePanel("tour-doc-links", false) }]
              : []),
