...
export const LEGGE_SBE_OCR_REPAIRS = [
  ...
  [/\bT he (fourth|fifth|sixth|third|second|first) line,/g, "The $1 line,"],
  [/\bthecireumstances\b/gi, "the circumstances"],
  [/\bBut-let\b/g, "But let"],
  [/\bWei 3 intimates\b/g, "Wei Zi intimates"],
  [/\battainsubject\b/gi, "attain. Its subject"],
  [/\s+—\s*$/g, ""],
  [/\bsuperior \} man\b/gi, "superior man"],
  [/\bin _ small things\b/gi, "in small things"],
  [/\bin _ small\b/gi, "in small"],
