...
const MOBILE_NATIVE_UI: Record<AppLocale, MobileNativeUiMessages> = {
  es: {
    ...
    downloadTooLargeBody: "Este archivo supera el límite seguro en móvil. Exporta desde la web en un hilo más corto.",
  ...
  en: {
    ...
    downloadTooLargeBody: "This file exceeds the safe limit on mobile. Export from the web app or use a shorter thread.",
  ...
  pt: {
    ...
    downloadTooLargeBody: "Este ficheiro excede o limite seguro no telemóvel. Exporte na web ou use um fio mais curto.",
    purchaseTitle: "Comprar tokens",
  ...
  fr: {
    ...
    downloadTooLargeBody: "Ce fichier dépasse la limite sûre sur mobile. Exportez depuis le web ou un fil plus court.",
  ...
  de: {
    ...
    downloadTooLargeBody: "Diese Datei überschreitet das sichere Limit auf dem Handy. Exportieren Sie über die Web-App oder einen kürzeren Thread.",
  ...
  it: {
    ...
    downloadTooLargeBody: "Questo file supera il limite sicuro su mobile. Esporta dal web o usa un filo più corto.",
  ...
  ja: {
    ...
    downloadTooLargeBody: "モバイルの安全な上限を超えています。Web版でエクスポートするか、より短いスレッドをご利用ください。",
  ...
  zh: {
    ...
    downloadTooLargeBody: "此文件超过移动端安全上限。请在网页版导出或使用较短的对话线程。",
    purchaseTitle: "购买代币",
  ...
  ko: {
    ...
    downloadTooLargeBody: "모바일 안전 한도를 초과합니다. 웹에서 내보내거나 더 짧은 스레드를 사용하세요.",
    purchaseTitle: "토큰 구매",
  ...
  ar: {
    ...
    downloadTooLargeBody: "يتجاوز هذا الملف الحد الآمن على الهاتف. صدّر من الويب أو استخدم محادثة أقصر.",
  ...
  hi: {
    ...
    downloadTooLargeBody: "यह फ़ाइल मोबाइल की सुरक्षित सीमा से बड़ी है। वेब से निर्यात करें या छोटा थ्रेड उपयोग करें।",
