...
const TERMS_BY_LOCALE: Record<AppLocale, TermsPageMessages> = {
  ...
  ar: {
    ...
    s2Title: "2) الأهلية والحساب",
    s2Items: [
      "يجب استخدام بيانات حساب دقيقة والحفاظ على سرية بيانات الوصول.",
      "أنت مسؤول عن النشاط الصادر من حسابك.",
      "يجوز لنا تعليق الحسابات في حالات الإساءة أو الاحتيال أو الانتهاكات الجوهرية.",
    ],
    s3Title: "3) باقات الرموز والمدفوعات",
    s3Items: [
      "تستخدم الخدمة باقات رموز قابلة للاستهلاك إضافةً إلى رصيد مجاني أولي لمرة واحدة.",
      "لا توجد رسوم متكررة أو تجديد تلقائي في النموذج الحالي.",
      "قد تُحدَّث الأسعار؛ وسيُعكس أي تغيير في المعلومات التجارية الحالية.",
    ],
    s4Title: "4) الاستخدام المقبول",
    s4Items: [
      "لا تستخدم الخدمة لأغراض غير مشروعة أو احتيالية أو تحرشية.",
      "لا تحاول الوصول غير المصرح به إلى الحسابات أو الأنظمة أو البيانات.",
    ...
    s7Title: "7) إخلاء المسؤولية وحدود المسؤولية",
    s7Items: [
      "القراءات ذات طابع رمزي وتفسيري.",
      "لا نضمن نتائج شخصية أو مالية أو صحية جراء الاستخدام.",
      "بالقدر الأقصى الذي يسمح به القانون، نحدّ من مسؤوليتنا عن الأضرار غير المباشرة أو التبعية.",
    ],
    s8Title: "8) الإنهاء",
    s8Body:
      "يمكنك التوقف عن استخدام الخدمة في أي وقت. يجوز لنا تعليق الوصول أو إنهاؤه في حالات الانتهاكات أو مخاطر الأمان أو المتطلبات القانونية.",
    s9Title: "9) إشعارات الشريك والمنتج",
    s9Body:
      "القراءات رمزية فحسب. تُلخَّص باقات الرموز والأسعار وخطوات الدفع في الدليل داخل التطبيق وفي منطقة الأسعار؛ وقد تتغير تفاصيل الشريك والمنتج بمرور الوقت.",
    s10Title: "10) التواصل",
    s10BeforeLink:
      "للاستفسارات المتعلقة بهذه الشروط أو الخصوصية، استخدم قنوات التواصل الرسمية المبيّنة على الموقع. معالجة البيانات الشخصية موضّحة في ",
    s10AfterLink: ".",
  },
  hi: {
    ...TERMS_EN,
    ...
    s2Title: "2) पात्रता और खाता",
    s2Items: [
      "आपको सटीक खाता डेटा का उपयोग करना होगा और अपनी पहुँच साख को गोपनीय रखना होगा।",
      "आप अपने खाते से की गई गतिविधि के लिए जिम्मेदार हैं।",
      "हम दुरुपयोग, धोखाधड़ी या महत्वपूर्ण उल्लंघनों के लिए खातों को निलंबित कर सकते हैं।",
    ],
    s3Title: "3) टोकन पैक और भुगतान",
    s3Items: [
      "सेवा उपभोज्य टोकन पैक और एक बार के प्रारंभिक निःशुल्क शेष का उपयोग करती है।",
      "वर्तमान मॉडल में कोई आवर्ती शुल्क या स्वतः-नवीनीकरण नहीं है।",
      "कीमतें अपडेट की जा सकती हैं; कोई भी बदलाव वर्तमान वाणिज्यिक जानकारी में परिलक्षित होगा।",
    ],
    s4Title: "4) स्वीकार्य उपयोग",
    s4Items: [
      "सेवा का उपयोग गैरकानूनी, धोखाधड़ी या उत्पीड़न गतिविधियों के लिए न करें।",
      "खातों, सिस्टम या डेटा तक अनधिकृत पहुँच का प्रयास न करें।",
    ...
    s7Title: "7) अस्वीकरण और दायित्व सीमाएं",
    s7Items: [
      "पठन प्रतीकात्मक और व्याख्यात्मक प्रकृति के हैं।",
      "हम उपयोग से व्यक्तिगत, वित्तीय या स्वास्थ्य परिणामों की गारंटी नहीं देते।",
      "कानून द्वारा अनुमत अधिकतम सीमा तक, हम अप्रत्यक्ष या परिणामी क्षति के लिए दायित्व को सीमित करते हैं।",
    ],
    s8Title: "8) समाप्ति",
    s8Body:
      "आप किसी भी समय सेवा का उपयोग बंद कर सकते हैं। हम उल्लंघनों, सुरक्षा जोखिम या कानूनी आवश्यकताओं के लिए पहुँच निलंबित या समाप्त कर सकते हैं।",
    s9Title: "9) भागीदार और उत्पाद नोटिस",
    s9Body:
      "पठन केवल प्रतीकात्मक हैं। टोकन पैक, मूल्य निर्धारण और चेकआउट चरण ऐप-इन-गाइड और मूल्य निर्धारण क्षेत्र में संक्षेपित हैं; भागीदार और उत्पाद विवरण समय के साथ बदल सकते हैं।",
    s10Title: "10) संपर्क",
    s10BeforeLink:
      "इन शर्तों या गोपनीयता के बारे में प्रश्नों के लिए, साइट पर बताए गए आधिकारिक संपर्क चैनलों का उपयोग करें। व्यक्तिगत डेटा प्रसंस्करण का वर्णन ",
    s10AfterLink: " में है।",
  },
  ko: {
    ...TERMS_EN,
