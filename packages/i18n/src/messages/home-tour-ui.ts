...
const HOME_TOUR_UI: Record<AppLocale, HomeTourUiMessages> = {
  es: {
    ...
    step7Title: "Biblioteca de Hexagramas", step7Body: "Consulta los 64 hexagramas con interpretación completa y comentario clásico desplegable. Disponible desde el nivel Seeker.",
  ...
  en: {
    ...
    step7Title: "Hexagram Library", step7Body: "Browse all 64 hexagrams with full interpretation and expandable classical commentary. Available from the Seeker tier.",
  ...
  pt: {
    ...
    step7Title: "Biblioteca de Hexagramas", step7Body: "Consulte os 64 hexagramas com interpretação completa e comentário clássico expansível. Disponível a partir do nível Seeker.",
  ...
  fr: {
    ...
    step7Title: "Bibliothèque des Hexagrammes", step7Body: "Consultez les 64 hexagrammes avec une interprétation complète et un commentaire classique dépliable. Disponible à partir du niveau Seeker.",
  ...
  de: {
    ...
    step7Title: "Hexagramm-Bibliothek", step7Body: "Durchsuche alle 64 Hexagramme mit vollständiger Interpretation und aufklappbarem klassischem Kommentar. Ab der Seeker-Stufe verfügbar.",
  ...
  it: {
    ...
    step7Title: "Biblioteca degli Esagrammi", step7Body: "Consulta tutti i 64 esagrammi con interpretazione completa e commento classico espandibile. Disponibile dal livello Seeker.",
  ...
  ja: {
    ...
    step7Title: "六十四卦ライブラリ", step7Body: "全64卦の完全な解釈と、展開できる古典注釈を閲覧できます。Seekerティア以上で利用可能。",
  ...
  zh: {
    ...
    step7Title: "六十四卦典库", step7Body: "浏览全部64卦的完整解读，以及可展开的古典注释。从Seeker等级起可用。",
  ...
  ko: {
    ...
    step7Title: "육십사괘 도서관", step7Body: "64개 모든 괘의 완전한 해석과 펼쳐볼 수 있는 고전 주석을 탐색하세요. Seeker 등급부터 이용 가능합니다.",
  ...
  ar: {
    ...
    step7Title: "مكتبة الهكساغرامات", step7Body: "تصفح جميع الـ 64 هكساغراماً مع تفسير كامل وتعليق كلاسيكي قابل للتوسيع. متاح من مستوى Seeker.",
  ...
  hi: {
    ...
    step7Title: "हेक्साग्राम पुस्तकालय", step7Body: "पूर्ण व्याख्या और विस्तार योग्य शास्त्रीय टिप्पणी सहित सभी 64 हेक्साग्राम देखें। Seeker स्तर से उपलब्ध।",
