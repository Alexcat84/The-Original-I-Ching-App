...
const HOME_TOUR_UI: Record<AppLocale, HomeTourUiMessages> = {
  es: {
    ...
    lineReadingTitle: "Sistema de Lectura", lineReadingBody: "Elige entre Alfred Huang (por defecto) o Zhu Xi (clásico) para interpretar las líneas en movimiento. Tu elección se recuerda.",
  ...
  en: {
    ...
    lineReadingTitle: "Reading System", lineReadingBody: "Choose between Alfred Huang (default) or Zhu Xi (classical) for interpreting the changing lines. Your choice is remembered.",
  ...
  pt: {
    ...
    lineReadingTitle: "Sistema de Leitura", lineReadingBody: "Escolha entre Alfred Huang (padrão) ou Zhu Xi (clássico) para interpretar as linhas em movimento. Sua escolha é lembrada.",
  ...
  fr: {
    ...
    lineReadingTitle: "Système de Lecture", lineReadingBody: "Choisissez entre Alfred Huang (par défaut) ou Zhu Xi (classique) pour interpréter les traits mobiles. Votre choix est mémorisé.",
  ...
  de: {
    ...
    lineReadingTitle: "Lesesystem", lineReadingBody: "Wähle zwischen Alfred Huang (Standard) oder Zhu Xi (klassisch) zur Deutung der bewegten Linien. Deine Wahl wird gespeichert.",
  ...
  it: {
    ...
    lineReadingTitle: "Sistema di Lettura", lineReadingBody: "Scegli tra Alfred Huang (predefinito) o Zhu Xi (classico) per interpretare le linee mobili. La tua scelta viene memorizzata.",
  ...
  ja: {
    ...
    lineReadingTitle: "読解システム", lineReadingBody: "変爻の読み方をAlfred Huang（既定）か朱熹（古典）から選べます。選択は記憶されます。",
  ...
  zh: {
    ...
    lineReadingTitle: "解卦系统", lineReadingBody: "选择用 Alfred Huang（默认）还是朱熹（古典）来解读变爻。你的选择会被记住。",
  ...
  ko: {
    ...
    lineReadingTitle: "해석 체계", lineReadingBody: "동효를 해석할 때 Alfred Huang(기본값) 또는 주희(고전) 중에서 선택하세요. 선택한 설정은 저장됩니다.",
  ...
  ar: {
    ...
    lineReadingTitle: "نظام القراءة", lineReadingBody: "اختر بين Alfred Huang (الافتراضي) أو Zhu Xi (الكلاسيكي) لتفسير الخطوط المتغيرة. يُحفظ اختيارك.",
  ...
  hi: {
    ...
    lineReadingTitle: "पठन प्रणाली", lineReadingBody: "बदलती रेखाओं की व्याख्या के लिए Alfred Huang (डिफ़ॉल्ट) या Zhu Xi (शास्त्रीय) में से चुनें। आपकी पसंद याद रखी जाती है।",
