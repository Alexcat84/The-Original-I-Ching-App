...
const HOME_TOUR_UI: Record<AppLocale, HomeTourUiMessages> = {
  es: {
    ...
    step4Title: "Modo de Oráculo", step4Body: "Elige el I Ching (monedas) o los Huesos de Oráculo (estilo Shang, el método de adivinación más antiguo de China).",
    ...
    step7Title: "Biblioteca de Hexagramas", step7Body: "Consulta los 64 hexagramas con interpretación completa y comentario clásico desplegable, o busca cualquier hexagrama por número, nombre o trigrama. Disponible desde el nivel Seeker.",
  ...
  en: {
    ...
    step4Title: "Oracle Mode", step4Body: "Choose I Ching (coins) or Oracle Bones (Shang style, the oldest Chinese divination method).",
    ...
    step7Title: "Hexagram Library", step7Body: "Browse all 64 hexagrams with full interpretation and expandable classical commentary, or search by number, name, or trigram. Available from the Seeker tier.",
  ...
  pt: {
    ...
    step4Title: "Modo de Oráculo", step4Body: "Escolha o I Ching (moedas) ou os Ossos de Oráculo (estilo Shang, o método de adivinhação mais antigo da China).",
    ...
    step7Title: "Biblioteca de Hexagramas", step7Body: "Consulte os 64 hexagramas com interpretação completa e comentário clássico expansível, ou pesquise qualquer hexagrama por número, nome ou trigrama. Disponível a partir do nível Seeker.",
  ...
  fr: {
    ...
    step4Title: "Mode Oracle", step4Body: "Choisissez le I Ching (pièces) ou les Os Oraculaires (style Shang, la méthode divinatoire la plus ancienne de Chine).",
    ...
    step7Title: "Bibliothèque des Hexagrammes", step7Body: "Consultez les 64 hexagrammes avec une interprétation complète et un commentaire classique dépliable, ou recherchez par numéro, nom ou trigramme. Disponible à partir du niveau Seeker.",
  ...
  de: {
    ...
    step4Title: "Orakel-Modus", step4Body: "Wähle zwischen I Ching (Münzen) oder Orakelknochen (Shang-Stil, die älteste chinesische Wahrsagemethode).",
    ...
    step7Title: "Hexagramm-Bibliothek", step7Body: "Durchsuche alle 64 Hexagramme mit vollständiger Interpretation und aufklappbarem klassischem Kommentar, oder such ein Hexagramm nach Nummer, Name oder Trigramm. Ab der Seeker-Stufe verfügbar.",
  ...
  it: {
    ...
    step4Title: "Modalità Oracolo", step4Body: "Scegli l'I Ching (monete) o le Ossa Oracolari (stile Shang, il metodo divinatorio più antico della Cina).",
    ...
    step7Title: "Biblioteca degli Esagrammi", step7Body: "Consulta tutti i 64 esagrammi con interpretazione completa e commento classico espandibile, o cerca per numero, nome o trigramma. Disponibile dal livello Seeker.",
  ...
  ja: {
    ...
    step4Title: "占いモード", step4Body: "易経（コイン）か神託骨（殷商スタイル、中国最古の占い方法）を選択してください。",
    ...
    step7Title: "六十四卦ライブラリ", step7Body: "全64卦の完全な解釈と展開できる古典注釈を閲覧できます。番号、名前、または三卦で検索することもできます。Seekerティア以上で利用可能。",
  ...
  zh: {
    ...
    step4Title: "神谕模式", step4Body: "选择易经（铜钱）或甲骨神谕（商朝风格，中国最古老的占卜方式）。",
    ...
    step7Title: "六十四卦典库", step7Body: "浏览全部64卦的完整解读及可展开的古典注释，或按编号、名称或卦象搜索。从Seeker等级起可用。",
  ...
  ko: {
    ...
    step4Title: "신탁 모드", step4Body: "주역(동전) 또는 신탁 뼈(상나라 양식, 중국에서 가장 오래된 점술 방법) 중 선택하세요.",
    ...
    step7Title: "육십사괘 도서관", step7Body: "64개 모든 괘의 완전한 해석과 펼쳐볼 수 있는 고전 주석을 탐색하거나, 번호, 이름 또는 괘로 검색하세요. Seeker 등급부터 이용 가능합니다.",
  ...
  ar: {
    ...
    step4Title: "وضع الأوراكل", step4Body: "اختر بين آي تشينغ (العملات) أو عظام الأوراكل (أسلوب شانغ، أقدم طريقة عرافة صينية).",
    ...
    step7Title: "مكتبة الهكساغرامات", step7Body: "تصفح جميع الـ 64 هكساغراماً مع تفسير كامل وتعليق كلاسيكي قابل للتوسيع، أو ابحث بالرقم أو الاسم أو الثلاثي. متاح من مستوى Seeker.",
  ...
  hi: {
    ...
    step4Title: "ओरेकल मोड", step4Body: "आई चिंग (सिक्के) या ओरेकल हड्डियाँ (शांग शैली, चीन की सबसे पुरानी भविष्यवाणी विधि) में से चुनें।",
    ...
    step7Title: "हेक्साग्राम पुस्तकालय", step7Body: "पूर्ण व्याख्या और विस्तार योग्य शास्त्रीय टिप्पणी सहित सभी 64 हेक्साग्राम देखें, या संख्या, नाम या त्रिग्राम द्वारा खोजें। Seeker स्तर से उपलब्ध।",
