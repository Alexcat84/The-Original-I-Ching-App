...
const GUIA_PACKS_UI: Record<AppLocale, GuiaPacksUiMessages> = {
  es: {
    ...
    libraryUnlockNote:
      "Acceso a la Biblioteca: La adquisición de cualquier pack de pago desbloquea de forma permanente el acceso a la Biblioteca, que contiene la colección completa de los 64 hexagramas en tres obras literarias: la traducción clásica de Wilhelm (1924), la versión de James Legge y el Zhou Yi original.",
  ...
  en: {
    ...
    libraryUnlockNote:
      "Library Access: Purchasing any paid pack permanently unlocks access to the Library, which contains the complete collection of 64 hexagrams across three literary works: the classic Wilhelm (1924) translation, the James Legge version, and the original Zhou Yi.",
    perPlanDetailHeading:
  ...
  pt: {
    ...
    libraryUnlockNote:
      "Acesso à Biblioteca: A aquisição de qualquer pacote pago desbloqueia permanentemente o acesso à Biblioteca, que contém a coleção completa dos 64 hexagramas em três obras literárias: a tradução clássica de Wilhelm (1924), a versão de James Legge e o Zhou Yi original.",
    perPlanDetailHeading:
  ...
  fr: {
    ...
    libraryUnlockNote:
      "Accès à la Bibliothèque : L'achat de tout pack payant débloque de façon permanente l'accès à la Bibliothèque, qui contient la collection complète des 64 hexagrammes à travers trois œuvres littéraires : la traduction classique de Wilhelm (1924), la version de James Legge et le Zhou Yi original.",
    perPlanDetailHeading:
  ...
  de: {
    ...
    libraryUnlockNote:
      "Bibliothekszugang: Der Kauf eines kostenpflichtigen Pakets schaltet dauerhaft den Zugang zur Bibliothek frei, die die vollständige Sammlung der 64 Hexagramme in drei literarischen Werken enthält: die klassische Wilhelm (1924)-Übersetzung, die James-Legge-Version und das originale Zhou Yi.",
    perPlanDetailHeading:
  ...
  it: {
    ...
    libraryUnlockNote:
      "Accesso alla Biblioteca: L'acquisto di qualsiasi pacchetto a pagamento sblocca in modo permanente l'accesso alla Biblioteca, che contiene la collezione completa di 64 esagrammi in tre opere letterarie: la traduzione classica di Wilhelm (1924), la versione di James Legge e l'originale Zhou Yi.",
    perPlanDetailHeading:
  ...
  ja: {
    ...
    libraryUnlockNote:
      "ライブラリへのアクセス: 有料パックを購入すると、ライブラリへのアクセスが永久にアンロックされます。ここには、古典的な Wilhelm (1924) 訳、James Legge 版、そして原文の Zhou Yi という 3 つの文学作品にわたる 64 卦の完全なコレクションが収録されています。",
    perPlanDetailHeading:
  ...
  zh: {
    ...
    libraryUnlockNote:
      "资料库访问权限：购买任何付费包即可永久解锁访问资料库的权限。资料库包含三部文学著作中完整的 64 卦象集：经典的卫礼贤（1924）译本、理雅各（James Legge）版本以及原始周易文本。",
  ...
  ko: {
    ...
    libraryUnlockNote:
      "라이브러리 액세스: 유료 팩을 구매하면 라이브러리 액세스 권한이 영구적으로 해제됩니다. 여기에는 고전적인 빌헬름 (1924) 번역, 제임스 레게 버전, 원문 주역 등 세 가지 문학 작품에 걸친 64괘 전체 컬렉션이 포함되어 있습니다.",
  ...
  ar: {
    ...
    libraryUnlockNote:
      "الوصول إلى المكتبة: يؤدي شراء أي حزمة مدفوعة إلى فتح الوصول الدائم إلى المكتبة، التي تحتوي على المجموعة الكاملة المكونة من 64 رمزاً عبر ثلاثة أعمال أدبية: ترجمة Wilhelm (1924) الكلاسيكية، ونسخة James Legge، ونص Zhou Yi الأصلي.",
    perPlanDetailHeading:
  ...
  hi: {
    ...
    libraryUnlockNote:
      "पुस्तकालय तक पहुंच: कोई भी भुगतान किया गया पैक खरीदने से पुस्तकालय तक पहुंच स्थायी रूप से अनलॉक हो जाती है, जिसमें तीन साहित्यिक कृतियों में 64 हेक्साग्राम का पूरा संग्रह है: क्लासिक विल्हेम (1924) अनुवाद, जेम्स लेगे संस्करण और मूल झोउ यी।",
    perPlanDetailHeading:
