...
const QUICKSTART_PAGE_UI: Record<AppLocale, QuickstartPageUiMessages> = {
  ...
  ar: {
    title: "البداية السريعة: كيفية استخدام التطبيق",
    ...
    s2Li2:
      "رؤية حالة عمق المحادثة النشطة (عدد القراءات المتسلسلة التي تسمح بها خطتك في تلك المحادثة).",
    s2Li3: "إدارة الرموز وشراء الباقات.",
    s2Li4: "إدارة الأمان الاختياري بالمصادقة الثنائية.",
    s2Li5: "روابط التوثيق والخصوصية والشروط موجودة أسفل اللوحة.",
    s3Heading: "3) النتائج والنسخة المحلية",
    s3Li1: "قد تتضمن كل استشارة تفسيرًا + صورة.",
    s3Li2:
      "إذا أردت سجلًا خارج التطبيق، تتيح لك الخيارات تنزيل الصورة وتصدير المحادثة الحالية بصيغة PDF؛ هذا اختياري والملف يُحفظ على جهازك وفق تقديرك.",
    s3Li3: "يمكنك حذف المحادثات من السجل (المحادثات).",
    legacyRedirectNotice: "جارٍ التحويل إلى دليل الاستخدام…",
  },
  hi: {
    title: "त्वरित शुरुआत: ऐप का उपयोग कैसे करें",
    ...
    s3Heading: "३) परिणाम और स्थानीय प्रति",
    s3Li1: "प्रत्येक परामर्श में व्याख्या + छवि शामिल हो सकती है।",
    s3Li2:
