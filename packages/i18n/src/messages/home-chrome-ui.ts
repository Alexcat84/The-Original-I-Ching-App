...
const HOME_CHROME_UI: Record<AppLocale, HomeChromeUiMessages> = {
  ...
  fr: {
    ...
    deleteAccountModalDesc: "Cette action est permanente et irréversible. Toutes tes données, ton historique et tes jetons seront supprimés. Écris DELETE pour confirmer.",
    deleteAccountConfirmPlaceholder: "Écris DELETE pour confirmer",
  ...
  de: {
    ...
    deleteAccountModalDesc: "Diese Aktion ist dauerhaft und nicht rückgängig zu machen. Alle deine Daten, der Verlauf und Token werden gelöscht. Gib DELETE ein, um zu bestätigen.",
    deleteAccountConfirmPlaceholder: "DELETE eingeben zur Bestätigung",
  ...
  it: {
    ...
    deleteAccountModalDesc: "Questa azione è permanente e irreversibile. Tutti i tuoi dati, la cronologia e i token verranno eliminati. Scrivi DELETE per confermare.",
    deleteAccountConfirmPlaceholder: "Scrivi DELETE per confermare",
