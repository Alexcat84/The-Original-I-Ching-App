...
const HOME_CHROME_UI: Record<AppLocale, HomeChromeUiMessages> = {
  es: {
    ...
    libraryDescription: "Textos clásicos y verificador de reglas de mutación.",
  ...
  en: {
    ...
    libraryDescription: "Classical texts and mutation rules verifier.",
    openLibrary: "Go to library",
    openMutationExplorer: "Rules verifier",
  ...
  pt: {
    ...
    openMutationExplorer: "Verificador de regras",
  ...
  fr: {
    ...
    openMutationExplorer: "Vérificateur de règles",
  ...
  de: {
    ...
    openMutationExplorer: "Regelprüfer",
  ...
  it: {
    ...
    openMutationExplorer: "Verificatore regole",
  ...
  ar: {
    ...
    openMutationExplorer: "مدقق القواعد",
  ...
  hi: {
    ...
    openMutationExplorer: "नियम सत्यापक",
