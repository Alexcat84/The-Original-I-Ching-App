...
const HOME_CHROME_UI: Record<AppLocale, HomeChromeUiMessages> = {
  es: {
    ...
    deleteAccountGroupAria: "Eliminar cuenta",
  ...
  en: {
    ...
    translatorMasterCostValue: "2 tokens",
    deleteAccountGroupAria: "Delete account",
  ...
  pt: {
    ...
    translatorMasterCostValue: "2 tokens",
    deleteAccountGroupAria: "Eliminar conta",
  ...
  fr: {
    ...
    deleteAccountGroupAria: "Supprimer le compte",
  ...
  de: {
    ...
    deleteAccountGroupAria: "Konto löschen",
  ...
  it: {
    ...
    translatorMasterCostLabel: "Costo:",
    translatorMasterCostValue: "2 token",
    deleteAccountGroupAria: "Elimina account",
  ...
  ja: {
    ...
    deleteAccountGroupAria: "アカウントを削除",
    deleteAccountHeading: "アカウントを削除",
  ...
  zh: {
    ...
    deleteAccountGroupAria: "删除账户",
    deleteAccountHeading: "删除账户",
  ...
  ko: {
    ...
    deleteAccountGroupAria: "계정 삭제",
    deleteAccountHeading: "계정 삭제",
  ...
  ar: {
    ...
    deleteAccountGroupAria: "حذف الحساب",
  ...
  hi: {
    ...
    deleteAccountGroupAria: "खाता हटाएं",
    deleteAccountHeading: "खाता हटाएं",
