...
const NOTES_PAGE_UI: Record<AppLocale, NotesPageUiMessages> = {
  ...
  zh: {
    ...
    ichingOriginBody:
      "周易——\"周之变化\"——是人类最古老的文献之一。其根源可追溯至周朝（公元前1046—256年），但其卜筮核心更为久远。该文本由不同历史层次累积而成：文王在囚禁中整理了64卦，并写下了卦辞（guàcí）；其子周公补充了六爻辞（爻辞，yáocí）；数百年后，孔子及其弟子增添了被称为十翼的传注，构成文本最深刻的哲学层次。",
    ...
    bonesOriginHeading: "历史渊源（商朝，约公元前1600—1046年）",
    bonesOriginBody:
