...
const NOTES_PAGE_UI: Record<AppLocale, NotesPageUiMessages> = {
  ...
  hi: {
    title: "पद्धति नोट्स और उद्गम",
    lead: "यह पृष्ठ ऐप में उपयोग की गई पद्धतियों की नींव समझाता है। यह तकनीकी-सांस्कृतिक संदर्भ है (उपयोग मार्गदर्शिका नहीं)।",
    ichingHeading: "I Ching (Zhouyi 周易)",
    ichingBody:
      "I Ching मोड 64-हेक्साग्राम परंपरा और बदलती-रेखा पठन से प्रेरित है। ऐप में इसे प्रतीकात्मक व्याख्या और व्यक्तिगत चिंतन के लिए आधुनिक तरीके से प्रस्तुत किया गया है।",
    bonesHeading: "ओरेकल हड्डियाँ (甲骨)",
    bonesBody:
      "हड्डियाँ मोड दरार ज्योतिष का संदर्भ लेता है और इसे डिजिटल हाँ/नहीं परामर्श प्रवाह में ढालता है।",
    interpretHeading: "इन पठनों की व्याख्या कैसे करें",
    interpretLi1: "ध्यान और परिप्रेक्ष्य के लिए एक प्रतीकात्मक उपकरण के रूप में।",
    interpretLi2: "गारंटीशुदा शाब्दिक भविष्यवाणी के रूप में नहीं।",
    interpretLi3: "व्यक्तिगत निर्णय और उचित होने पर पेशेवर सलाह के पूरक के रूप में।",
    sourcesHeading: "गहन अध्ययन के लिए बाहरी संदर्भ",
  },
};
