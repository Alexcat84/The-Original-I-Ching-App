...
const PRICING_UI: Record<AppLocale, PricingUiMessages> = {
  ...
  hi: {
    title: "टोकन पैक",
    balanceLoggedIn: "आपके पास {{count}} टोकन उपलब्ध हैं",
    balanceUnknown: "अपना शेष देखने के लिए लॉग इन करें",
    modelLine: "सक्रिय मॉडल 100% उपभोज्य टोकन पैक पर आधारित है।",
    tokensAccumulate:
      "आपके टोकन जमा होते हैं: यदि आप टोकन समाप्त होने से पहले नया पैक खरीदते हैं, तो शेष टोकन नए पैक में जुड़ जाते हैं।",
    threadLimitDepends:
      "प्रति थ्रेड अधिकतम श्रृंखलाबद्ध प्रश्न आपके कुल टोकन शेष पर निर्भर नहीं करते: यह हमेशा आपके द्वारा खरीदे गए अंतिम पैक से तय होता है (जैसे Seeker अधिकतम 3, Practitioner अधिकतम 5, Master अधिकतम 8 प्रति थ्रेड)। प्रत्येक नई खरीद उस पैक के अनुसार सीमा अपडेट करती है।",
    perThreadCap: "प्रति थ्रेड अधिकतम {{n}} प्रश्न",
