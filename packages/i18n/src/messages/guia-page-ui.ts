...
const GUIA_PAGE_UI: Record<AppLocale, GuiaPageUiMessages> = {
  es: {
    ...
    leadPart2: " y ",
    leadPart3:
      ". Es una herramienta de reflexión y orientación simbólica. No sustituye consejo médico, legal o financiero.",
    bonesLabel: "Huesos",
  ...
  en: {
    ...
    leadPart2: " and ",
    leadPart3:
      ". It is a symbolic reflection tool and should not replace medical, legal, or financial advice.",
    bonesLabel: "Bones",
  ...
  pt: {
    ...
    leadPart2: " e ",
    leadPart3:
      ". É uma ferramenta de reflexão e orientação simbólica. Não substitui aconselhamento médico, jurídico ou financeiro.",
    bonesLabel: "Ossos",
    ...
    optionsIntro:
      "Em Opções escolhes o tipo de consulta (I Ching ou Ossos), vês a profundidade permitida no fio ativo, geres tokens e 2FA, e no final tens ligações à documentação e legal.",
  ...
  fr: {
    ...
    leadPart2: " et ",
    leadPart3:
      ". C’est un outil de réflexion et d’orientation symbolique. Il ne remplace pas un avis médical, juridique ou financier.",
    bonesLabel: "Os",
    ...
    optionsIntro:
      "Dans Options vous choisissez le type de consultation (I Ching ou Os), voyez la profondeur autorisée du fil actif, gérez les jetons et la 2FA, et trouvez en bas les liens documentation et mentions légales.",
  ...
  de: {
    ...
    leadPart2: " und ",
    leadPart3:
      ". Sie ist ein Werkzeug für symbolische Reflexion und Orientierung. Sie ersetzt keine medizinische, rechtliche oder finanzielle Beratung.",
    bonesLabel: "Knochen",
    ...
    optionsIntro:
      "In Optionen wählst du den Beratungstyp (I Ching oder Knochen), siehst die erlaubte Tiefe im aktiven Thread, verwaltest Token und 2FA und findest unten Links zu Dokumentation und Rechtlichem.",
  ...
  it: {
    ...
    leadPart2: " e ",
    leadPart3:
      ". È uno strumento di riflessione e orientamento simbolico. Non sostituisce pareri medici, legali o finanziari.",
    bonesLabel: "Ossa",
    privacyHeading: "Privacy",
    privacyLi1:
    ...
    optionsIntro:
      "In Opzioni scegli il tipo di consulta (I Ching o Ossa), vedi la profondità consentita nel thread attivo, gestisci token e 2FA e in fondo trovi link a documentazione e testi legali.",
  ...
  ja: {
    ...
    leadPart2: " と ",
    leadPart3:
      "。象徴的な内省と方向づけのためのツールであり、医療・法律・金融のアドバイスに代わるものではありません。",
    bonesLabel: "甲骨",
    ...
    optionsIntro:
      "オプションでは相談タイプ（I Ching または甲骨）、アクティブスレッドの深さ、トークンと2FAの管理を行い、下部にドキュメントと法務リンクがあります。",
  ...
  zh: {
    ...
    optionsIntro:
      "在选项中选择咨询类型（I Ching 或甲骨）、查看当前会话允许的深度、管理代币与双因素认证，底部有文档与法律链接。",
  ...
  ko: {
    ...
    leadPart2: " 및 ",
    leadPart3:
      ". 상징적 성찰과 방향 제시를 위한 도구이며 의료·법률·재무 조언을 대체하지 않습니다.",
    bonesLabel: "갑골",
    privacyHeading: "개인정보",
    ...
    optionsIntro:
      "옵션에서 상담 유형(I Ching 또는 갑골), 활성 스레드의 허용 깊이, 토큰 및 2FA를 관리하고 하단에 문서·법적 링크가 있습니다.",
