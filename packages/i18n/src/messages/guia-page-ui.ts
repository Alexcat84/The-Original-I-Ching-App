...
const GUIA_PAGE_UI: Record<AppLocale, GuiaPageUiMessages> = {
  es: {
    ...
    ichingTraditionNote:
      "La app implementa el sistema de reducción a una sola línea de Alfred Huang, con la estructura clásica de Zhu Xi como antecedente, para que toda combinación de líneas produzca siempre un único texto guía preciso.",
  ...
  en: {
    ...
    ichingTraditionNote:
      "The app implements Alfred Huang's single-line reduction system, with Zhu Xi's classical structure as its antecedent, so that every combination of changing lines always yields a single, precise guiding text.",
    ...
    s2Heading: "The Options Panel (Control Center)",
    s2TranslatorsTitle: "Translator Selector",
    s2Translators: "Your tool for choosing the wisdom lineage of your consultation. Levels activate according to your current pack.",
    s2TokensTitle: "Token Center",
    s2Tokens: "Manage your cumulative balance and access new mastery levels.",
    s2SecurityTitle: "Security (2FA)",
    s2Security: "Two-factor authentication settings to protect your account's privacy.",
    ...
    s5ManualTitle: "Manual",
    s5Manual: "Interactive wizard to input your own physical throws (Coins or Stalks).",
  ...
  pt: {
    ...
    ichingTraditionNote:
      "O app implementa o sistema de redução a uma única linha de Alfred Huang, com a estrutura clássica de Zhu Xi como antecedente, para que toda combinação de linhas produza sempre um único texto guia preciso.",
    ...
    s2Heading: "O Painel de Opções (Centro de Controlo)",
    s2TranslatorsTitle: "Seletor de Tradutores",
    s2Translators: "A tua ferramenta para escolher a tradição de sabedoria da tua consulta. Os níveis ativam-se conforme o teu pack atual.",
    s2TokensTitle: "Centro de Tokens",
    s2Tokens: "Gestão do teu saldo acumulável e acesso à aquisição de novos níveis de mestria.",
    s2SecurityTitle: "Segurança (2FA)",
    s2Security: "Configuração da autenticação de dois fatores para proteger a privacidade da tua conta.",
    ...
    s5ManualTitle: "Manual",
    s5Manual: "Assistente interativo para inserir as tuas próprias tiradas físicas (Moedas ou Varas).",
  ...
  fr: {
    ...
    ichingTraditionNote:
      "L’application met en œuvre le système de réduction à un seul trait d’Alfred Huang, avec la structure classique de Zhu Xi comme antécédent, pour que chaque combinaison de traits produise toujours un texte directeur unique et précis.",
    ...
    s2Heading: "Le panneau Options (centre de contrôle)",
    s2TranslatorsTitle: "Sélecteur de traducteurs",
    s2Translators: "Ton outil pour choisir la tradition de sagesse de ta consultation. Les niveaux s'activent selon ton pack actuel.",
    s2TokensTitle: "Centre de tokens",
    s2Tokens: "Gestion de ton solde cumulatif et accès à l'acquisition de nouveaux niveaux de maîtrise.",
    s2SecurityTitle: "Sécurité (2FA)",
    s2Security: "Configuration de l'authentification à deux facteurs pour protéger la confidentialité de ton compte.",
    ...
    s5ManualTitle: "Manuel",
    s5Manual: "Assistant interactif pour entrer tes propres tirages physiques (pièces ou tiges).",
  ...
  de: {
    ...
    ichingTraditionNote:
      "Die App setzt Alfred Huangs Einzel-Linien-Reduktionssystem um, mit Zhu Xis klassischem Rahmen als Vorläufer, damit jede Strichkombination stets einen einzigen, präzisen Leittext ergibt.",
    ...
    s2Heading: "Das Optionen-Panel (Kontrollzentrum)",
    s2TranslatorsTitle: "Übersetzerauswahl",
    s2Translators: "Dein Werkzeug zur Wahl der Weisheitstradition deiner Konsultation. Die Stufen aktivieren sich je nach deinem aktuellen Pack.",
    s2TokensTitle: "Token-Zentrum",
    s2Tokens: "Verwaltung deines kumulierten Guthabens und Zugang zu neuen Meisterstufen.",
    s2SecurityTitle: "Sicherheit (2FA)",
    s2Security: "Einrichtung der Zwei-Faktor-Authentifizierung zum Schutz der Privatsphäre deines Kontos.",
    ...
    s5ManualTitle: "Manuell",
    s5Manual: "Interaktiver Assistent zur Eingabe eigener physischer Würfe (Münzen oder Stäbe).",
  ...
  it: {
    ...
    ichingTraditionNote:
      "L’app implementa il sistema di riduzione a linea singola di Alfred Huang, con la struttura classica di Zhu Xi come precedente, in modo che ogni combinazione di linee produca sempre un unico testo guida preciso.",
    ...
    s2Heading: "Il pannello Opzioni (centro di controllo)",
    s2TranslatorsTitle: "Selettore di traduttori",
    s2Translators: "Il tuo strumento per scegliere la tradizione di saggezza della tua consultazione. I livelli si attivano in base al tuo pack attuale.",
    s2TokensTitle: "Centro token",
    s2Tokens: "Gestione del tuo saldo cumulabile e accesso all'acquisizione di nuovi livelli di maestria.",
    s2SecurityTitle: "Sicurezza (2FA)",
    s2Security: "Configurazione dell'autenticazione a due fattori per proteggere la privacy del tuo account.",
    ...
    s5ManualTitle: "Manuale",
    s5Manual: "Assistente interattivo per inserire i propri lanci fisici (monete o bastoncini).",
  ...
  ja: {
    ...
    ichingTraditionNote:
      "このアプリはアルフレッド・ホアンの一爻還元システムを採用しています。朱熹の古典的な枠組みをその前身としつつ、どの変爻の組み合わせでも常に的確な主爻テキストが一つに定まります。",
    ...
    s2Heading: "オプションパネル（コントロールセンター）",
    s2TranslatorsTitle: "翻訳者セレクター",
    s2Translators: "相談の知恵の系統を選ぶツール。レベルは現在のパックに応じて有効になります。",
    s2TokensTitle: "トークンセンター",
    s2Tokens: "累積残高の管理と新しいマスタリーレベルの取得。",
    s2SecurityTitle: "セキュリティ（2FA）",
    s2Security: "アカウントのプライバシーを保護するための二段階認証の設定。",
    ...
    s5ManualTitle: "手動",
    s5Manual: "自分の物理的なキャスト（コインや茎）を入力するインタラクティブウィザード。",
  ...
  zh: {
    ...
    ichingTraditionNote:
      "本应用采用 Alfred Huang 的单爻归简系统，以朱熹的古典框架为其源头，确保每种变爻组合都能呈现一个精准、明确的主导爻辞。",
    ...
    s2Heading: "选项面板（控制中心）",
    s2TranslatorsTitle: "译者选择器",
    s2Translators: "选择咨询智慧传承的工具。级别根据您当前的套餐激活。",
    s2TokensTitle: "代币中心",
    s2Tokens: "管理您的累积余额并获取新的掌握级别。",
    s2SecurityTitle: "安全（2FA）",
    s2Security: "配置双因素认证以保护您账户的隐私。",
    ...
    s5ManualTitle: "手动",
    s5Manual: "输入您自己实物起卦（硬币或蓍草）的交互向导。",
    s6Heading: "资料库与文档",
  ...
  ko: {
    ...
    ichingTraditionNote:
      "이 앱은 Alfred Huang의 단일 효 환원 체계를 구현하며, 주희의 고전적 틀을 그 선행 구조로 삼습니다. 그래서 어떤 동효 조합에서도 항상 정확한 지도 효사 하나를 얻을 수 있습니다.",
    ...
    s2Heading: "옵션 패널 (제어 센터)",
    s2TranslatorsTitle: "번역자 선택기",
    s2Translators: "상담의 지혜 계통을 선택하는 도구입니다. 현재 팩에 따라 레벨이 활성화됩니다.",
    s2TokensTitle: "토큰 센터",
    s2Tokens: "누적 잔액 관리 및 새로운 마스터리 레벨 획득.",
    s2SecurityTitle: "보안 (2FA)",
    s2Security: "계정 개인정보 보호를 위한 이중 인증 설정.",
    ...
    s5ManualTitle: "수동",
    s5Manual: "직접 물리적 점복(동전 또는 시초)을 입력하는 대화형 마법사.",
  ...
  ar: {
    ...
    ichingTraditionNote:
      "يطبّق التطبيق نظام ألفريد هوانغ لاختزال الخط الواحد، مع قواعد زو شي الكلاسيكية كأصل تاريخي لهذا البناء، لضمان أن كل تركيبة من الخطوط المتغيرة تُنتج دائمًا نصًا راهنًا واحدًا ودقيقًا.",
    ...
    s2Heading: "لوحة الخيارات (مركز التحكم)",
    s2TranslatorsTitle: "محدد المترجمين",
    s2Translators: "أداتك لاختيار سلالة الحكمة لاستشارتك. تُفعَّل المستويات وفقًا لحزمتك الحالية.",
    s2TokensTitle: "مركز الرموز",
    s2Tokens: "إدارة رصيدك التراكمي والوصول إلى مستويات الإتقان الجديدة.",
    s2SecurityTitle: "الأمان (2FA)",
    s2Security: "إعداد المصادقة الثنائية لحماية خصوصية حسابك.",
    ...
    s5ManualTitle: "يدوي",
    s5Manual: "مساعد تفاعلي لإدخال قرعتك الفيزيائية الخاصة (عملات أو عصي).",
  ...
  hi: {
    ...
    ichingTraditionNote:
      "यह ऐप अल्फ्रेड हुआंग की एक-रेखा न्यूनीकरण प्रणाली को लागू करता है, जिसमें झू शी की शास्त्रीय संरचना इसके ऐतिहासिक आधार के रूप में है — ताकि परिवर्तनशील रेखाओं का हर संयोजन हमेशा एक सटीक मार्गदर्शक पाठ उत्पन्न करे।",
    ...
    s2Heading: "विकल्प पैनल (नियंत्रण केंद्र)",
    s2TranslatorsTitle: "अनुवादक चयनकर्ता",
    s2Translators: "अपनी परामर्श की ज्ञान परंपरा चुनने का आपका उपकरण। स्तर आपके वर्तमान पैक के अनुसार सक्रिय होते हैं।",
    s2TokensTitle: "टोकन केंद्र",
    s2Tokens: "आपके संचयी शेष का प्रबंधन और नए महारत स्तरों तक पहुँच।",
    s2SecurityTitle: "सुरक्षा (2FA)",
    s2Security: "आपके खाते की गोपनीयता की सुरक्षा के लिए द्वि-कारक प्रमाणीकरण सेटअप।",
    ...
    s5ManualTitle: "मैन्युअल",
    s5Manual: "अपने स्वयं के भौतिक थ्रो (सिक्के या छड़ें) दर्ज करने के लिए इंटरैक्टिव विज़ार्ड।",
