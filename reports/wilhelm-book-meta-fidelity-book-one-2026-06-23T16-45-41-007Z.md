# Wilhelm book meta fidelity (book-one)

- Parsed: `C:\Users\AlexDesk\Documents\iching-app\tools\datasets\wilhelm\book-one\wilhelm-64hex-parsed.json`
- Generated: 2026-06-23T16:45:41.008Z

## Summary

| Check | Result |
|-------|--------|
| nombre/chinese match book header | **PASS** (64/64) |
...
## Book `chinese` header vs bundle hanzi

| Hex | Book header | Bundle `trad_chinese` |
|-----|-------------|----------------------|
| 1 | Ch'ien | 乾 |
| 2 | K'un | 坤 |
| 3 | Chun | 屯 |
...
_… 64/64 use Wade-Giles in book header vs hanzi in bundle._
