...
| 📱 **Android App** | Native WebView APK with full offline-capable chrome and image saving |
...
**Current version:** 3.0.0 (versionCode 3) · **Platform:** Android · **Min SDK:** 24
...
└── backend/
    └── db/migrations/        # 22 ordered SQL migrations (Supabase)
```
